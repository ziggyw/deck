...
import { ReactInjector, ReactModal, TaskMonitor, WizardModal, WizardPage } from '@spinnaker/core';
...
export class CloneServerGroupAlicloud extends React.Component {
  ...
  private submit = (values: any): void => {
    ...
    if (values.viewState.mode !== 'create') {
      ...
      taskMonitor.submit(() => ReactInjector.serverGroupWriter.cloneServerGroup(values, application));
    }
  };
  public render() {
