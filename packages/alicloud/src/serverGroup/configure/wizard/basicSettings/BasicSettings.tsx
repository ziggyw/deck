    ...
    return (
      <>
        ...
        <div className="form-group">
          ...
          {!values.region && <h5 className="text-center col-md-7">(please select region)</h5>}
          {values.region && (
            <div className="col-md-7">
              <Select
        ...
        <div className="form-group">
          <div className="col-md-3 sm-label-right">MaxSize</div>
          <div className="col-md-3">
            <input
              required={true}
              type="number"
          ...
          <div className="col-md-6 form-inline">
            <div className="col-md-4 sm-label-right">MinSize</div>
            <input
              required={true}
              min="0"
              max="1000"
