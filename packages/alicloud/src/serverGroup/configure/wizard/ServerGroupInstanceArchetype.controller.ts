...
export const ALICLOUD_SERVERGROUP_INSTANCEARCHETYPE =
  'spinnaker.alicloud.serverGroup.configure.instanceArchetype.controller';
angular.module(ALICLOUD_SERVERGROUP_INSTANCEARCHETYPE, []).controller('alicloudInstanceArchetypeCtrl', [
  '$scope',
  'instanceTypeService',
  'modalWizardService',
