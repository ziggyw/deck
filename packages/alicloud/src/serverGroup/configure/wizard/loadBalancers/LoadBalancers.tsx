...
export class LoadBalancers extends React.Component<ISubnetOption, {}> {
  ...
  private getAsyncData = (vpcId: any) => {
    ...
    const that = this;
    new LoadBalancerReader(this.$q, {})
      .getLoadBalancerDetails('alicloud', values.credentials, values.region, values.application)
  ...
  public render(): React.ReactElement {
    ...
    return (
      <>
        {values.vSwitchId === null && <h5 className="text-center">Please select an subnet.</h5>}
