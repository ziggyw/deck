...
export const ALICLOUD_SERVERGROUP_SECURITY_DIRECTIVE =
  'spinnaker.alicloud.serverGroup.configure.securityGroupSelector.directive';
angular.module(ALICLOUD_SERVERGROUP_SECURITY_DIRECTIVE, []).directive('alicloudServerGroupSecurityGroupsSelector', [
