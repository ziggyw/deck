...
import { HelpField, REST } from '@spinnaker/core';
...
export class ServerGroupSecurityId extends React.Component<ISubnetOption, {}> {
  ...
  private getAsyncDate = (e: any) => {
    ...
    const that = this;
    REST(`firewalls/${values.credentials}?provider=alicloud`)
      .get()
    ...
    REST('instanceTypes')
      ...
      .then(function (types: any[]) {
        ...
        types.forEach((item: any) => {
          if (
            item.account === values.credentials &&
            item.regionId === values.region &&
            item.zoneId === values.masterZoneId
          ) {
      ...
      <>
        {values.region === null ? (
          ...
          <div onClick={() => this.getImage()}>
            ...
            <div className="form-group">
              <div className="col-md-3 sm-label-right">SpotStrategy</div>
              <div className="col-md-7">
                <Select
                  className="form-control input-sm"
            ...
            {values.scalingConfigurations.spotStrategy === 'SpotWithPriceLimit' && (
              <div className="form-group">
                <div className="col-md-3 sm-label-right">SpotPriceLimit</div>
                <div className="col-md-7">
                  <input
                    type="number"
                    className="form-control input-sm"
            ...
            />
            <div className="form-group">
              <div className="col-md-3 sm-label-right">Password</div>
              <div className="col-md-7">
                <input
                  type="password"
                  className="form-control input-sm"
                ...
                />
                {valids && values.scalingConfigurations.password && (
                  <span className="error" style={{ color: 'red' }}>
                    Enter the content in the correct format
                  </span>
                )}
              </div>
            </div>
            ...
            <div className="form-group">
              <div className="col-md-3 sm-label-right">RamRoleName</div>
              <div className="col-md-7">
                <input
                  className="form-control input-sm"
            ...
            <div className="form-group">
              <div className="col-md-3 sm-label-right">MaxBandwidthOut</div>
