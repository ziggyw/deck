...
export const ALICLOUD_SERVERGROUP_INSTANCE =
  'spinnaker.alicloud.serverGroup.configure.securityGroupSelector.instancedirective';
angular
  .module(ALICLOUD_SERVERGROUP_INSTANCE, [])
