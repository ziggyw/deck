...
export class ServerGroupImage extends React.Component<ISubnetOption, {}> {
  constructor(props: ISubnetOption) {
    ...
    this.state = {
      ...
      isimage: false,
      imageName: props.command.scalingConfiguration
        ? props.command.scalingConfiguration.imageId
        : props.command.scalingConfigurations.imageId,
    };
  }
  ...
  private getDate = (newVal: any) => {
    ...
    REST('images/find?provider=alicloud')
      .query({ q: newVal })
      .get()
    ...
    return (
      <>
        <div className={'row form-group'} id="enquiry_contact">
          {laybel === 3 ? (
            <label className="col-md-3 sm-label-right">ImageId</label>
          ) : (
            <label className="col-md-4 sm-label-right">ImageId</label>
          )}
          {!isimage ? (
            ...
            <div className="col-md-7" style={{ height: '30px', position: 'relative', zIndex: 3 }}>
              <div contentEditable={true} onClick={(e: any) => this.getSearchValue(e)} style={{ height: '0px' }} />
              <input
                placeholder="search"
                id="imgId"
                          ...
                          <>
                            <div
                              ...
                              style={{
                                ...
                                padding: '0 10px',
                                background: imageName === images.imageName ? '#1d8499' : '',
                              }}
