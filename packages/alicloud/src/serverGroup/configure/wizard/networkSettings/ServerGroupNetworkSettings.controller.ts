...
export const ALICLOUD_SERVERGROUP_NETWORKSETTING =
  'spinnaker.alicloud.serverGroup.configure.networkSettings.controller';
angular.module(ALICLOUD_SERVERGROUP_NETWORKSETTING, []).controller('alicloudServerGroupNetworkSettingsCtrl', [
  '$scope',
  function ($scope: any) {
