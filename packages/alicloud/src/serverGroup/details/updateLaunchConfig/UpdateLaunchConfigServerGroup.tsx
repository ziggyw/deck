...
import { ModalClose, ReactModal, REST, TaskMonitor, TaskMonitorWrapper } from '@spinnaker/core';
...
export class UpdateLaunchConfigServerGroup extends React.Component {
  constructor(props: any) {
    ...
    this.state = {
      ...
      priceLimit:
        serverGroup.launchConfig.spotPriceLimit.length > 1
          ? serverGroup.launchConfig.spotPriceLimit[0].priceLimit
          : null,
        ...
        REST('subnets/alicloud')
          ...
          .then((vnets: any) => {
            ...
            types.forEach((item: any) => {
              if (
                item.account === serverGroup.account &&
                item.regionId === serverGroup.region &&
                item.zoneId === zoneIds
              ) {
        ...
        <Modal.Body>
          <form role="form" name="UpdateLaunchConfig">
            <div className="form-group row">
              <div className="col-md-4 sm-label-right">SystemDisk.Category</div>
            ...
            <div className="form-group row">
              <div className="col-md-4 sm-label-right">SystemDisk.Size</div>
              <div className="col-md-7">
                <input
                  type="number"
                  min="40"
            ...
            <div className="form-group row">
              <div className="col-md-4 sm-label-right">SpotStrategy</div>
              <div className="col-md-7">
                <select
                  className="form-control input-sm"
                  onChange={(e) => this.handleChange(e)}
            ...
            {spotStrategy === 'SpotWithPriceLimit' && (
              <div className="form-group row">
                <div className="col-md-4 sm-label-right">SpotPriceLimit</div>
                <div className="col-md-7">
                  <input
                    className="form-control input-sm"
                    value={priceLimit}
            ...
            <div className="form-group row">
              <div className="col-md-4 sm-label-right">MaxBandwidthOut</div>
              ...
              <div className="col-md-6 form-inline">
                <label className="sm-label-right">LoadBalancerWeight</label>
                <input
                  type="number"
                  min="0"
                  max="100"
            ...
            <div className="form-group row">
              <div className="container-fluid form-horizontal col-md-10 col-md-offset-1">
                <TagsSelector command={serverGroup.result} onChange={(e: any) => this.handleTags(e)} />
              </div>
            </div>
          </form>
        </Modal.Body>
