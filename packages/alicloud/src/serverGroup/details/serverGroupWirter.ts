...
import type { Application, IJob, IMoniker, ISecurityGroup, IServerGroupCommand, ITask } from '@spinnaker/core';
import { FirewallLabels, NameUtils, TaskExecutor } from '@spinnaker/core';
import type { ICapacity } from '@spinnaker/core';
import type { IAsg, IEntityTags, IExecution, IInstance, IInstanceCounts } from '@spinnaker/core';
...
export class ServerGroupWriters {
  ...
  public cloneServerGroups(command: IServerGroupCommand, application: Application): PromiseLike<ITask> {
  ...
  public updateLaunchConfigs(serverGroup: IServerGroup, application: Application): PromiseLike<ITask> {
    const job: IServerGroupJobs = {
      cloudProvider: serverGroup.type || serverGroup.provider,
      credentials: serverGroup.account,
      region: serverGroup.region,
