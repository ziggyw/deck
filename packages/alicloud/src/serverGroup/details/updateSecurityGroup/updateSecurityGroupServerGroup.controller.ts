...
export const ALICLOUD_SERVERGROUP_DETAIL_UPDATESECURITY =
  'spinnaker.alicloud.serverGroup.details.updateSecurityGroup.controller';
angular
  .module(ALICLOUD_SERVERGROUP_DETAIL_UPDATESECURITY, [SERVER_GROUP_WRITER_ALI, ALICLOUD_FOOTER_DIRECTIVE])
  .controller('alicloudUpdateSecurityGroupServerGroupCtrl', [
    ...
    function ($scope: any, $uibModalInstance: any, serverGroupWriters: any, application: any, serverGroup: any) {
      ...
      $scope.verification = {};
      REST()
        .path(...`firewalls/${$scope.serverGroup.account}?provider=alicloud`.split('/'))
        .get()
