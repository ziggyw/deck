...
import { ModalClose, noop, ReactInjector, ReactModal, REST, TaskMonitor, TaskMonitorWrapper } from '@spinnaker/core';
...
export class AlicloudUpdateServerGroupModal extends React.Component {
  ...
  public componentDidMount = () => {
    ...
    REST(`firewalls/${serverGroup.account}?provider=alicloud`)
      .get()
      .then(
        function (firwalls: any) {
          const val: any[] = [];
