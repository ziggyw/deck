...
// import { $uibModal } from '@uirouter/angularjs';
...
export class ServerGroupDetail extends React.Component {
  ...
  private enableServerGroup = () => {
    ...
    const submitMethod = (params: any) => {
      return ReactInjector.serverGroupWriter.enableServerGroup(serverGroups, app, params);
    };
  ...
  private rollbackServerGroup = () => {
    ...
    AlicloudRollbackServerGroupModal.show({
      application: app,
      serverGroup: serverGroups,
      disabledServerGroups: disableServerGroups,
    });
  };
          ...
          <>
            <div className="header">
              ...
              <div className="header-text horizontal middle">
                ...
                <h3 className="horizontal middle space-between flex-1">{serverGroup.name}</h3>
              </div>
              <div className={`"actions" ${serverGroup.insightActions.length} > 0 ? "insights" : null`}>
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu" role="menu">
                    <li>
                      <a onClick={this.rollbackServerGroup}>Rollback</a>
                    </li>
                    {serverGroup.isDisabled ? (
                      <li>
                        <a onClick={this.enableServerGroup}>Enable</a>
                      </li>
                    ) : (
                      <>
                        <li>
                          <a onClick={this.cloneServerGroup}>Clone</a>
                        </li>
                        <li>
                          <a onClick={this.resizeServerGroup}>Resize</a>
                        </li>
                        <li>
                          <a onClick={this.disableServerGroup}>Disable</a>
                        </li>
                      </>
                    )}
                    <li>
                      <a onClick={this.destroyServerGroup}>Destroy</a>
                    </li>
                  </ul>
                </div>
                {serverGroup.insightActions.length > 0 && (
                  <div className="dropdown">
            ...
            <div className="content">
              {serverGroup.isDisabled && <h4 className="text-center">[SERVER GROUP IS DISABLED]</h4>}
              {/* <RunningTasks/> */}
              <CollapsibleSection heading={'Server Group Information'}>
                <dl>
                  ...
                  <button disabled={serverGroup.isDisabled} onClick={this.reScalingGroupServerGroup}>
                    Edit ScalingGroup
                  </button>
                </dl>
              </CollapsibleSection>
              ...
              <CollapsibleSection heading={'firewallsLabel'}>
                <dl>
                  ...
                  <button disabled={serverGroup.isDisabled} onClick={this.updateSecurityGroupServerGroup}>
              ...
              <CollapsibleSection heading={'tag'}>
                {(serverGroup.result.scalingConfiguration.tags !== [] ||
                  serverGroup.result.scalingConfiguration.tags !== null) && (
                  <>
              ...
              <CollapsibleSection heading={'ystemDisk'}>
                <dl className="dl-horizontal dl-flex">
                  ...
                  <button disabled={serverGroup.isDisabled} onClick={this.updateLaunchConfigServerGroup}>
                    UpdateLaunchConfig
                  </button>
                </dl>
              </CollapsibleSection>
