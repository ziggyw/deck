                ...
                <thead>
                  <tr>
                    ...
                    <th style={{ width: '32%' }}>
                      ...
                      <HelpField id="alicloud.securityGroup.ingress.sourceIPCIDRRanges" />
                    </th>
                    <th style={{ width: '16%' }}>
                      Start Port ranges
                      <HelpField id="alicloud.securityGroup.ingress.destPortRanges" />
                    </th>
                    <th style={{ width: '16%' }}>
                      End Port ranges
                      <HelpField id="alicloud.securityGroup.ingress.destPortRanges" />
                    ...
                    <th style={{ width: '15%' }}>
                      Actions
                      <HelpField id="alicloud.securityGroup.ingress.actions" />
                    </th>
                  </tr>
                </thead>
                <tbody>
                      ...
                      <tr key={index}>
                        <td>
                          <select
                            ...
                            onChange={(event) => this.sourceIngressUpdated(rule, event.target.value)}
                          >
                        ...
                        <td>
                          <input
                            ...
                            onChange={(event) => this.sourceIPCIDRUpdated(rule, event.target.value)}
                            required={true}
                          />
                        </td>
                          ...
                          <>
                            <td>
                              <input
                                ...
                                onChange={(event) => this.startPortRangeChange(rule, event.target.value)}
                                required={true}
                            ...
                            <td>
                              <input
                                ...
                                onChange={(event) => this.endPortRangeChange(rule, event.target.value)}
                                required={true}
                        ...
                        <td>
                          <a
                            ...
                            onClick={() => this.moveUp(values.securityGroupIngress, index)}
                          >
                            <span className="glyphicon glyphicon-arrow-up" />
                          </a>
                          <a
                            className="btn-link sm-label"
                            onClick={() => this.moveDown(values.securityGroupIngress, index)}
                          >
                            <span className="glyphicon glyphicon-arrow-down" />
                          </a>
                          <a
                            className="btn-link sm-label"
                            onClick={() => this.removeRule(values.securityGroupIngress, index)}
                          >
