...
import { AccountService, FirewallLabels, REST, TaskMonitor } from '@spinnaker/core';
...
angular
  .module(ALICLOUD_SECURITY_CREATECTRL, [UIROUTER_ANGULARJS, ALICLOUD_SECURITY_WRITE_SERVICE])
      ...
      ctrl.upsert = function () {
        ...
        $scope.taskMonitor.submit(function () {
          const params = {
            ...
            subnet: $scope.securityGroup.vswitchId || null,
          };
