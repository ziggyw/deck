...
import { AccountTag, CollapsibleSection, ConfirmationModalService, ReactModal, Spinner } from '@spinnaker/core';

import { AlicloudSecurityGroupWriter } from '../securityGroup.write.service';
// import {IModalService as $uibModal} from '@types/angular-ui-bootstrap';
        ...
        <div className="details-panel">
          ...
          {loading && (
            <div className="content">
              ...
              <CollapsibleSection heading={`Security Rules ({securityGroup.inboundRules.length || 0})`}>
                {!securityGroup.inboundRules.length && <div>None</div>}
