...
export const ALICLOUD_EVALUATE_CLOUD_FORMATION_CHANGE_SET_EXECUTION_SERVICE =
  'spinnaker.alicloud.deployCloudFormation.service';
module(ALICLOUD_EVALUATE_CLOUD_FORMATION_CHANGE_SET_EXECUTION_SERVICE, [EXECUTION_SERVICE]).service(
