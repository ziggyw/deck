            ...
            <dl className="dl-horizontal dl-flex">
              ...
              {loadBalancer.elb.results.attributes.addressType !== 'internet' && (
                <>
                  ...
                  <dt>Subnet</dt>
                  <dd>{loadBalancer.elb.results.vswitchId}</dd>
                </>
              )}
            </dl>
            <dl>
              ...
              return (
                <>
                  <dl style={{ borderBottom: '1px solid #eee', paddingBottom: '20px' }}>
                    ...
                    {loadBalancingRule.cookie == null ||
                      (!loadBalancingRule.cookie && (
                        <>
                          <dt>Cookie</dt>
                          <dd>{loadBalancingRule.cookie}</dd>
                        </>
                      ))}
                    {loadBalancingRule.cookieTimeout == null ||
                      (!loadBalancingRule.cookieTimeout && (
                        <>
                          <dt>CookieTimeout</dt>
                          <dd>{loadBalancingRule.cookieTimeout} seconds</dd>
                        </>
                      ))}
                    {loadBalancingRule.gzip == null ||
                      (!loadBalancingRule.gzip && (
                        <>
                          <dt>Gzip</dt>
                    ...
                    {loadBalancingRule.stickySessionType == null ||
                      (!loadBalancingRule.stickySessionType && (
                        <>
                          <dt>StickySessionType</dt>
                          <dd>{loadBalancingRule.stickySessionType}</dd>
                        </>
                      ))}
                    {loadBalancingRule.requestTimeout == null ||
                      (!loadBalancingRule.requestTimeout && (
                        <>
                          <dt>RequestTimeout</dt>
                          <dd>{loadBalancingRule.requestTimeout} seconds</dd>
                        </>
                      ))}
                    <dt>Scheduler</dt>
