...
import { AccountService, LoadBalancerWriter, NameUtils, REST, TaskMonitor } from '@spinnaker/core';
...
angular
  .module(ALICLOUD_LOADBALANCER_CREATE, [UIROUTER_ANGULARJS, ALICLOUD_LOADBALANCER_BALANCER])
