        ...
        <SpinFormik<IRedirectActionConfig>
          ...
          render={({ isValid }) => (
            <Form className="form-horizontal">
              ...
              <Modal.Header>
                <Modal.Title>
                  Configure Redirect <HelpField id="alicloud.loadBalancer.redirect" />
                </Modal.Title>
              </Modal.Header>
              ...
              <Modal.Body>
                {/* <FormikFormField
                  ...
                  help={<HelpField id="alicloud.loadBalancer.redirect.host" />}
                /> */}
                <FormikFormField
                  name="path"
                  label="Path"
                  required={false}
                  input={(props) => <TextInput {...props} />}
                  help={<HelpField id="alicloud.loadBalancer.redirect.path" />}
                />
                <FormikFormField
                  name="port"
                  label="Port"
                  required={false}
                  input={(props) => <TextInput {...props} />}
                  help={<HelpField id="alicloud.loadBalancer.redirect.port" />}
                />
                <FormikFormField
                  name="protocol"
                  label="Protocol"
                  ...
                  help={<HelpField id="alicloud.loadBalancer.redirect.protocol" />}
                />
                <FormikFormField
                  name="query"
                  label="Query"
                  required={false}
                  input={(props) => <TextInput {...props} />}
                  help={<HelpField id="alicloud.loadBalancer.redirect.query" />}
                />
                <FormikFormField
                  name="httpCode"
                  label="Http Code"
