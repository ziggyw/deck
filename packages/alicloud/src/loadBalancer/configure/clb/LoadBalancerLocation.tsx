...
import { AccountSelectInput, AccountService, HelpField, REST, Spinner, ValidationMessage } from '@spinnaker/core';
      ...
      .then((vnets: any) => {
        ...
        vnets.forEach((vnet: any) => {
          if (vnet.account === values.credentials && vnet.region === region) {
            subnets.push({
              value: vnet.vswitchName + '/' + vnet.vswitchId,
              name: vnet.vswitchName,
              zoneId: vnet.zoneId,
              id: vnet.vswitchId,
              label: vnet.vswitchName + '/' + vnet.vswitchId,
            });
          }
        });
        that.setState({
        ...
        <div className="container-fluid form-horizontal">
          ...
          {accounts && (
            <div className="modal-body">
              ...
              <div className="form-group">
                <div className="col-md-3 sm-label-right">LoadBalancerSpec</div>
                <div className="col-md-7">
                  <Select
