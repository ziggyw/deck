...
> {
  ...
  constructor(props: any) {
    ...
    const loadBalancerCommands = command
      ...
      : loadBalancer
      ? new AlicloudLoadBalancerTransformer(this.$q).convertLoadBalancerForEditing(loadBalancer)
      : new AlicloudLoadBalancerTransformer(this.$q).constructNewLoadBalancerTemplate(application);
