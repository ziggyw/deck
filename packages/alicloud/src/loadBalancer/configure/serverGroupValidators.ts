...
export const isValidTimeout = (targetGroup: any): IValidator => (value: number | string) => {
...
export const isValidHealthCheckInterval = (targetGroup: any): IValidator => (value: string) =>
