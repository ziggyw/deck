...
import type { IFunctionFromStateParams } from './AlicloudFunctionDetails';
import { CreateLambdaFunction } from '../CreateLambdaFunction';
import { ALICLOUDProviderSettings } from '../alicloud.settings';
import type { AlicloudFunction, AlicloudFunctionDeleteCommand } from '../../domain';
...
export class FunctionActions extends React.Component<IFunctionActionsProps, IFunctionActionsState> {
  ...
  public deleteFunction = (): void => {
    ...
    const command: AlicloudFunctionDeleteCommand = {
  ...
  public render() {
    ...
    return (
      <div style={{ display: 'inline-block' }}>
        {ALICLOUDProviderSettings.adHocInfraWritesEnabled && (
