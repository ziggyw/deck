...
describe('FunctionActions', () => {
  it('should render correct state when all attributes exist', () => {
    ...
    const functionDef = { functionName: 'app-function' } as AlicloudFunction;
    ALICLOUDProviderSettings.adHocInfraWritesEnabled = true;
  ...
  it('should not render DropdownToggle if alicloud.adHocInfraWritesEnabled is false', () => {
    const app = { name: 'app' } as Application;

    const functionDef = { functionName: 'app-function' } as AlicloudFunction;
    ALICLOUDProviderSettings.adHocInfraWritesEnabled = false;
