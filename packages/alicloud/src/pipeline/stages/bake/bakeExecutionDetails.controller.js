...
import generated from '@uirouter/angularjs';
import { get } from 'lodash';

import { SETTINGS } from '@spinnaker/core';

export const ALICLOUD_PIPELINE_STAGES_BAKE_BAKEEXECUTIONDETAILS_CONTROLLER =
  'spinnaker.alicloud.pipeline.stage.bake.executionDetails.controller';
export const name = ALICLOUD_PIPELINE_STAGES_BAKE_BAKEEXECUTIONDETAILS_CONTROLLER; // for backwards compatibility
angular
  .module(ALICLOUD_PIPELINE_STAGES_BAKE_BAKEEXECUTIONDETAILS_CONTROLLER, [generated])
