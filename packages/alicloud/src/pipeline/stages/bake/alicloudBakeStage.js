...
import { AuthenticationService, BakeryReader, PipelineTemplates, Registry, SETTINGS } from '@spinnaker/core';
import { ALICLOUD_PIPELINE_STAGES_BAKE_BAKEEXECUTIONDETAILS_CONTROLLER } from './bakeExecutionDetails.controller';

export const ALICLOUD_PIPELINE_STAGES_BAKE_ALICLOUDBAKESTAGE = 'spinnaker.alicloud.pipeline.stage.bakeStage';
export const name = ALICLOUD_PIPELINE_STAGES_BAKE_ALICLOUDBAKESTAGE; // for backwards compatibility
angular
  .module(ALICLOUD_PIPELINE_STAGES_BAKE_ALICLOUDBAKESTAGE, [
    ALICLOUD_PIPELINE_STAGES_BAKE_BAKEEXECUTIONDETAILS_CONTROLLER,
  ])
  .config(function () {
