...
export const ALICLOUD_PIPELINE_STAGES_FINDAMI_ALICLOUDFINDAMISTAGE = 'spinnaker.alicloud.pipeline.stage.findAmiStage';
export const name = ALICLOUD_PIPELINE_STAGES_FINDAMI_ALICLOUDFINDAMISTAGE; // for backwards compatibility
angular
  .module(ALICLOUD_PIPELINE_STAGES_FINDAMI_ALICLOUDFINDAMISTAGE, [])
  .config(function () {
    Registry.pipeline.registerStage({
      ...
      validators: [{ type: 'requiredField', fieldName: 'cluster' }],
    });
  })
