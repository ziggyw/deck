...
export const ALICLOUD_PIPELINE_STAGES_ENABLEASG_ALICLOUDENABLEASGSTAGE =
  'spinnaker.alicloud.pipeline.stage.enableAsgStage';
export const name = ALICLOUD_PIPELINE_STAGES_ENABLEASG_ALICLOUDENABLEASGSTAGE; // for backwards compatibility
angular
  .module(ALICLOUD_PIPELINE_STAGES_ENABLEASG_ALICLOUDENABLEASGSTAGE, [])
  .config(function () {
