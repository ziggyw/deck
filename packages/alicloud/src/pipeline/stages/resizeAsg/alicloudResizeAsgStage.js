...
export const ALICLOUD_PIPELINE_STAGES_RESIZEASG_ALICLOUDRESIZEASGSTAGE =
  'spinnaker.alicloud.pipeline.stage.alicloud.resizeAsgStage';
export const name = ALICLOUD_PIPELINE_STAGES_RESIZEASG_ALICLOUDRESIZEASGSTAGE; // for backwards compatibility
angular
  .module(ALICLOUD_PIPELINE_STAGES_RESIZEASG_ALICLOUDRESIZEASGSTAGE, [])
  .config(function () {
